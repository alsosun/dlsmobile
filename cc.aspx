<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="cc.aspx.vb" Inherits="dlsmobile.cc"%>
...
<body>
	...
	<div id="header" data-role="header" data-position="fixed" data-theme="c">
		<div class="header_wrapper">
			...
			<span class="page_title">Common Core</span>
	...
	<div data-role="content">
		<div class="container">
			<h1 style="text-align:center">Subject Area</h1>
            <p style="text-align:center">
                <asp:DropDownList ID="areadd" runat="server" AutoPostBack="True" style="font-size: x-large; font-weight: 700">
                <asp:ListItem Selected="True">select</asp:ListItem>
                <asp:ListItem>Language Arts</asp:ListItem>
                <asp:ListItem>Mathematics</asp:ListItem>
                <asp:ListItem>HS Algebra</asp:ListItem>
                <asp:ListItem>HS Functions</asp:ListItem>
                <asp:ListItem>HS Geometry</asp:ListItem>
                <asp:ListItem>HS Number and Quantity</asp:ListItem>
                <asp:ListItem>HS Statistics and Probability</asp:ListItem>
                </asp:DropDownList>
            ...
            <h1 style="text-align:center">Strand</h1>
            <p style="text-align:center">
                <asp:DropDownList ID="stranddd" runat="server" AutoPostBack="True" style="font-size: x-large; font-weight: 700">
                </asp:DropDownList>

            </p>
            <h1 style="text-align:center">Standards</h1>
            <p style="text-align:center">
